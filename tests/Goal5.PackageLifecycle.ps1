...
try {
    ...
    Assert-PshGoal5 ([string]$diskCurrentDecision.Action -ceq 'CompleteCommit' -and [bool]$diskCurrentDecision.Safe) 'Strict on-disk current state did not prove a completed commit.'
