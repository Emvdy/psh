...
<!-- Generated by scripts/Generate-CommandArtifacts.ps1 from src/Psh/Specification/commands.psd1 and src/install/config.psd1. Do not edit. -->
...
initial contents select the Core edition and enable all Psh commands:
